...
do_install:append:stm32mpcommon() {
    ...
    rm -f ${D}${nonarch_base_libdir}/firmware/brcm/brcmfmac43439-sdio*
    ...
    ln -sf BCM4343A2.hcd BCM.st,${CUBEMX_DTB}.hcd
}

FILES:${PN}:append:stm32mpcommon = " \
    ${nonarch_base_libdir}/firmware/brcm/BCM4343A2.hcd \
    ${nonarch_base_libdir}/firmware/brcm/BCM.st,${CUBEMX_DTB}.hcd \
"
